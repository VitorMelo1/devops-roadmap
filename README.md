...
# Go to Step 01 and make scripts executable
cd 01-linux-fundamentals/scripts
chmod +x *.sh
...
I'm a Software Engineering student building toward a DevOps internship. Instead of just taking courses, I document everything I learn — scripts, cheatsheets, real notes — in a format that's reusable and reviewable.

Each folder represents one step of the journey. Every script here was written and tested. Every note was earned.
...
Software Engineering student at **UniEvangélica** (Brazil), building real-world projects while learning DevOps fundamentals.

Currently working on:
- **NeuroMent** — adaptive learning SaaS (Django + React)
- **IVI** — AI-powered assistive vision system (FastAPI + YOLOv11)
- **SANEAGO** — hackathon project for water service digitalization

📎 [LinkedIn](https://www.linkedin.com/in/your-profile) · 📧 vitormmelo04@gmail.com

---

> *"The best way to learn DevOps is to do it in public."*
